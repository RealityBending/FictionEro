...
df1 <- read.csv("https://raw.githubusercontent.com/RealityBending/FictionEro/refs/heads/main/study1/data/data.csv") |> 
  ...
  mutate(Condition = fct_recode(Condition, "Photograph" = "Photograph", "AIGenerated" = "AI-Generated"),
         Condition = fct_relevel(Condition, "Photograph", "AI-Generated"),
...
BAIT <- dfsub1[grepl("^BAIT_", names(dfsub1))]

BAIT_a <- psych::omega(BAIT, n_factors= 1)

```

McDonald's Omega (⍵) total was acceptable for BAIT total (⍵ = `r round(BAIT_a$omega.tot,2)`.
