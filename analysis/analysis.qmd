...
<!-- - condition as random intercept for participant converged but not sure whether we should keep intercepts different or the same for the models? -->

<!-- ```{r} -->

<!-- m_arousal1 <- glmmTMB::glmmTMB(Arousal ~ Gender / Relevance / Condition + (Relevance | Participant) + (Relevance|Item), data=df1, family=glmmTMB::ordbeta(), control = glmmTMB::glmmTMBControl(parallel = 8)) -->


<!-- m_arousal2 <- glmmTMB::glmmTMB(Arousal ~ Gender/ Condition + (1| Participant) + (1|Item), family=glmmTMB::ordbeta(), data=df2, control = glmmTMB::glmmTMBControl(parallel = 8)) -->
<!-- ``` -->

```{r}
df1 |> 
  ggplot(aes(x = Gender, y = Arousal, fill = ConditionBelief)) +
  geom_violin(position = position_dodge(width = 1), alpha = 0.6, trim = FALSE) +
  stat_pointinterval(
  ...
  labs(
    title = "Arousal by Gender × Belief × Relevance × Condition",
    x = "Gender",
    y = "Arousal",
    fill = " Condition Belief"
  )
...
arousal1_cr <- readRDS("models/ModelArousal_1_CR.rds")


#Individual models

m <- readRDS("models/individual_models/ModelArousal_1_task_1.rds")
m <- readRDS("models/individual_models/ModelArousal_1_task_2.rds")
m <- readRDS("models/individual_models/ModelArousal_1_task_3.rds")
m <- readRDS("models/individual_models/ModelArousal_1_task_4.rds")
m <- readRDS("models/individual_models/ModelArousal_1_task_5.rds")
m <- readRDS("models/individual_models/ModelArousal_1_task_6.rds")

# 
# m <- readRDS("models/individual_models/ModelArousal_2_task_1.rds")
# m <- readRDS("models/individual_models/ModelArousal_2_task_2.rds")
# m <- readRDS("models/individual_models/ModelArousal_2_task_3.rds")
# m <- readRDS("models/individual_models/ModelArousal_2_task_4.rds")
# m <- readRDS("models/individual_models/ModelArousal_2_task_5.rds")
# m <- readRDS("models/individual_models/ModelArousal_2_task_6.rds")
