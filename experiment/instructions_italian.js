...
var text_instructions1 =
    ...
    "<p style='text-align: left; margin-left: 30%; margin-right: 30%;'> Dopo ogni immagine, ti sarà chiesto di esprimere un giudizio sulla scala seguente:</p>" +    "<ul style='text-align: left; margin-left: 30%; margin-right: 30%;'>" +
    // Arousal: embodied
...
var text_endscreen = function (
    link = "https://realitybending.github.io/FictionEro/experiment/english?exp=snow&lang=en" *** OR NOT???
) {
    return (
