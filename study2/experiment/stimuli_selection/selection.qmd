...
In this study, we select only the 25 most arousing items that align with the participants' sexual orientation. For example, homosexual men will be shown the 25 most arousing images of males and male couples. While this approach reduces variability in arousal levels, it is more appropriate for our categorical analysis to focus exclusively on high-arousal stimuli.

Additionally, insights from our previous study suggest that introducing neutral images between arousing ones diminishes participants' ability to maintain arousal, given that arousal tends to build over time. Images that evoke aversion can further disrupt arousal, undermining participants' ability to remain aroused immediately afterward. 
