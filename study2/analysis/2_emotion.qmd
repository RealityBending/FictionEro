...
```{r Enticement Model with stimuly type}
...
marginaleffects::avg_slopes(m_enticement_st, variables="Condition", by="Gender") |>
  results_table()
...
marginaleffects::avg_slopes(m_valence_st, variables="Condition", by="Gender") |>
  results_table()
...
marginaleffects::avg_slopes(m_emotionality_st, variables="Condition", by="Gender", re.form=NA) |>
  results_table()
```
