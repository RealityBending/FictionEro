...
pred |>
  ...
  geom_hline(yintercept=0, color="darkgrey") +
  geom_line(aes(group=Gender, color=Gender), position = position_dodge(width=0.2), alpha=0.8, linewidth=0.4, key_glyph = "path") +
  ...
  geom_rect(data=data.frame(Outcome = "Arousal", Probability=0.1, Type=as.factor("Single")),
            aes(xmin=0.8, xmax=1.2, ymin=0.27, ymax=0.65), color="#8BC34A", alpha=0, linewidth = 1.5) +
  geom_rect(data=data.frame(Outcome = "Enticement", Probability=0.1, Type=as.factor("Single")),
            aes(xmin=1.8, xmax=2.2, ymin=0.3, ymax=0.68), color="#8BC34A", alpha=0, linewidth = 1.5) +
  geom_rect(data=data.frame(Outcome = "Enticement", Probability=0.1, Type=as.factor("Single")),
            aes(xmin=2.8, xmax=3.2, ymin=0.33, ymax=0.71), color="#8BC34A", alpha=0, linewidth = 1.5) +
...
<!-- pred_t <- rbind( -->
<!--   modelbased::estimate_means(m_type_a, by=c("Gender", "ConditionBelief", "Type"), backend = "emmeans") |> -->
<!--   as.data.frame() |>  -->
<!--   mutate(Outcome="Arousal"), -->
<!--   modelbased::estimate_means(m_type_e, by=c("Gender","ConditionBelief", "Type"), backend = "emmeans") |> -->
<!--   as.data.frame() |>  -->
<!--   mutate(Outcome="Enticement"), -->
<!--   modelbased::estimate_means(m_type_v, by=c("Gender","ConditionBelief", "Type"), backend = "emmeans") |> -->
<!--   as.data.frame() |>  -->
<!--   mutate(Outcome="Valence") -->
<!-- ) -->
...
<!--   # geom_text(data=stars1a, aes(y=y, label=label), hjust=0.5, color="#424242", size=6) + -->
<!--   geom_rect(data=data.frame(Outcome = "Arousal", Probability=0.1, Type=as.factor("Single")), -->
<!--             aes(xmin=0.8, xmax=1.2, ymin=0.27, ymax=0.65), color="#8BC34A", alpha=0, linewidth = 0.5) + -->
<!--   geom_rect(data=data.frame(Outcome = "Enticement", Probability=0.1, Type=as.factor("Single")), -->
<!--             aes(xmin=1.8, xmax=2.2, ymin=0.3, ymax=0.68), color="#8BC34A", alpha=0, linewidth = 0.5) + -->
<!--   geom_rect(data=data.frame(Outcome = "Enticement", Probability=0.1, Type=as.factor("Single")), -->
<!--             aes(xmin=2.8, xmax=3.2, ymin=0.33, ymax=0.71), color="#8BC34A", alpha=0, linewidth = 0.5) + -->
<!--   facet_grid(Congruence~Type, switch="y", scales ="free") + -->
<!--   scale_y_continuous(limits=c(0, 1)) + -->
<!--   scale_color_manual(values=c("Male"="#147AFF", "Female"="#FF9914")) + -->
<!--   theme_minimal() + -->
<!--     theme(axis.title.y = element_blank(), -->
