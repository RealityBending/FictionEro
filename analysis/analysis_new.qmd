...
```{r mean arousal for feedback ai less arousing}
df1 |>
...
ttest1 <- BayesFactor::ttestBF(dfsub1_arousal$diff_arousal, dfsub1_arousal$Feedback_AILessArousing)
...
```{r mean enticement for feedback ai less arousing}
df1 |>
  group_by(Feedback_AILessArousing, Condition ) |>
...
```{r mean valence for feedback ai less arousing}
df1 |>
  group_by(Feedback_AILessArousing, Condition ) |>
...
#### Marginal contrasts without Type
