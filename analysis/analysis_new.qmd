...
colors <- c(
  ...
  "Relevance:ConditionAIGenerated" = "#FF9800", 
  "RelevanceNonErotic"  = "#43A047", 
  "NonErotic:ConditionAIGenerated"  = "#E53935",
  "Irrelevant:ConditionAIGenerated" = "#00897B")
...
```{r df 2 corr}
correlations2 <- df2 |>
  select(Participant, starts_with("Feedback"), starts_with("BAIT"), "PornFrequency", "SexualActivity_num", "COPS_Frequency", "AllRealConfidence", "AllFakeConfidence", "Enjoyment")
