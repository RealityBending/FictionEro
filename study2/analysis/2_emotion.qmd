...
```{r}
for(m in c("Feedback_DiffObvious", "Feedback_DiffNone","Feedback_DiffSubtle", 
...
Looking at **feedback** as a moderator, the results show that for males, emotionality ratings for AI-Generated images were negatively moderated by the feedback that AI images were more attractive.  
