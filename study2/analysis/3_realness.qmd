...
To examine the unique role of **Arousal** in predicting **perceived realness**, a model was tested including both linear and quadratic effects of Arousal, along with its interactions with Gender and Condition (AI-generated vs. real images), modeling participants and images as random intercepts. 
