...
psych::omega(GAAIS_Negative, n_factors= 1)
psych::omega(GAAIS_Positive, n_factors= 1)
...
psych::alpha(BAIT_Text)
psych::alpha(BAIT_Images)
psych::alpha(BAIT_Videos)
psych::alpha(BAIT_Enviornment)
```
...
psych::omega(BAIT_Expectations, nfactors = 1)
psych::omega(BAIT_Attitudes, nfactors = 1)
psych::omega(BAIT_Expertise, nfactors = 1)
psych::omega(BAIT_Discrimination, nfactors = 1)
psych::omega(BAIT_Bias, nfactors = 1)
```
