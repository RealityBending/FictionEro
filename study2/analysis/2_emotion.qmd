...
This model evaluate ths the effects of Gender on Arousal, accounting for random variability due to participants (i.e., random effects). The analysis revealed that on average **women rate erotic stimuli significantly lower in arousal than men**, while participants identifying as 'other' rate on average erotic stimuli higher than men, however this is not significant.
...
The analysis revealed that on average **women rate erotic stimuli significantly lower in valence than men**, while participants identifying as 'other' rate on average erotic stimuli higher in valence than men but these was not statistically significant.
