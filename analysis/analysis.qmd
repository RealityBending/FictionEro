...
```{r}
# Function to load, summarize, and check performance of ZOIB model
summarize_zoib <- function(file_path) {
...
```{r}
arousal1_ZOIB <- summarize_zoib("models/ZOIB/ModelArousal_1_ZOIB.rds")
```
...
```{r}
enticement1_ZOIB <- summarize_zoib("models/ZOIB/ModelEnticement_1_ZOIB.rds")
```
...
```{r}
valence1_ZOIB <- summarize_zoib("models/ZOIB/ModelValence_1_ZOIB.rds")
```
...
```{r}
arousal2_ZOIB <- summarize_zoib("models/ZOIB/ModelArousal_2_ZOIB.rds")
```
...
```{r}
enticement2_ZOIB <- summarize_zoib("models/ZOIB/ModelEnticement_2_ZOIB.rds")
```
...
```{r}
valence2_ZOIB <- summarize_zoib("models/ZOIB/ModelValence_2_ZOIB.rds")
```
...
```{r}
m <- readRDS("C:/Users/asf25/Downloads/ModelArousal_1_task_1.rds")
...
```{r}
m <- readRDS("C:/Users/asf25/Downloads/ModelEnticement_1_task_1.rds")
...
##### Arousal 
```{r}
m <- readRDS("C:/Users/asf25/Downloads/ModelArousal_2_task_1.rds")
...
```{r}
m <- readRDS("C:/Users/asf25/Downloads/ModelEnticement_2_task_1.rds")
...
```{r}
m <- readRDS("C:/Users/asf25/Downloads/ModelValence_2_task_1.rds")
